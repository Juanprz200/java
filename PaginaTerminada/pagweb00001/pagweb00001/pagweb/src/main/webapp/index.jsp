...
<div class="contenedor">
    <header class="superior">
        ...
        <nav class="menu">
            <ul class="opcions">
                <li><a href="" target="_self">cita</a></li>
    ...
    <div class="contenedor-principal">
        <button id="flecha-izquierda" class="flecha-izquierda"><i class="fas fa-arrow-circle"></i> </button>
...
<form action="servletAgenda"method="get">
    ...
    <input class="boton" type="submit" name="agendamiento" value="cancelar">
